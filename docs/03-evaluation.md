...
1. **第三臂的绝对有效曝光比 KOXPilot 高**（19.67M vs 13.47M，**12/12 个种子都如此**）。它按每美元曝光排序，专挑 CPM 最便宜的长尾；KOXPilot 优化质量加权价值，会主动放弃便宜但不对味的曝光。绝对曝光数不是 KOXPilot 的优化目标——这条写出来，不用"我们曝光也最多"糊过去。**并且不止绝对数**：按每美元有效曝光归一化，第三臂在三条 brief 上分别高 47.4% / 47.5% / 44.0%，我把它连同取舍写进了 [README「第三臂在主指标上打赢了我」](../README.md)，没有靠"口径不可比"绕开。
